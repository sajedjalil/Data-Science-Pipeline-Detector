...
"""
I got max score in version 62 (0.785 on Kaggle Leaderboard) with the following parameters:
...
Also I tried to use parameters, found with Bayesian optimization but only got 0.783 score.
"""
'''
