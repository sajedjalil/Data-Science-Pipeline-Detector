...
for i in range (1000):
    s = 0
    if i < 200:
        s = weigh('gloves') + weigh('train') + weigh('blocks') + weigh('horse') + weigh('doll') + weigh('ball') + weigh('book')
    elif i < 996:
        s = weigh('train') + weigh('blocks') + weigh('horse') + weigh('doll') + weigh('ball') + weigh('ball')
    else:
        a = []
        for j in range(23):
            s += weigh('ball')
