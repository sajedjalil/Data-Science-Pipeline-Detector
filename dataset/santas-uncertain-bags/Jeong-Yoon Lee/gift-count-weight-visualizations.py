...
if __name__ == '__main__':
    ...
    gifts_df.ix[:, 'gift_type'] = gifts_df.GiftId.apply(lambda x: x.split('_')[0])
    # drop bikes and coal from the list
    gifts_df = gifts_df.ix[(gifts_df.gift_type != 'bike') & (gifts_df.gift_type != 'coal')]
