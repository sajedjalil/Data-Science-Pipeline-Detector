...
def generate_sample():
    sample = {}
    sample['ball'] = [max(0, 1 + np.random.normal(1,0.3,1)[0]) for i in range(21000)]
    sample['bike'] = [max(0, np.random.normal(20,10,1)[0]) for i in range(10000)]
    sample['blocks'] = [np.random.triangular(5,10,20,1)[0] for i in range(20000)]
    sample['book'] = [np.random.chisquare(2,1)[0] for i in range(22000)]
    sample['coal'] = [47 * np.random.beta(0.5,0.5,1)[0] for i in range(16600)]
    sample['doll'] = [np.random.gamma(5,1,1)[0] for i in range(30000)]
    sample['gloves'] = [3.0 + np.random.rand(1)[0] if np.random.rand(1) < 0.3 else np.random.rand(1)[0] for i in range(20000)]
    sample['horse'] = [max(0, np.random.normal(5,2,1)[0]) for i in range(40000)]
    sample['train'] = [max(0, np.random.normal(10,5,1)[0]) for i in range(40000)]
    return sample
