...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  6 15:13:30 2016
...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if book_month<1 or book_month>12 or book_year<2012 or book_year>2015 or book_year != 2014:
            #print(book_month)
            #print(book_year)
            #print(line)
            continue
...
#         if total % 200000 == 0:
#             print("line: ", line)
#             print("append_0: ", append_0)
#             print("append_1: ", append_1)
#             print("append_2: ", append_2)
#==============================================================================
