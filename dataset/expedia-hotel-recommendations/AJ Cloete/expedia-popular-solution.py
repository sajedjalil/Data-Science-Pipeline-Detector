...
# added: take weight into account, as provided in cnt variable
...
def prepare_arrays_match():
    ...
    while 1:
        ...
        append_0 = cnt*((book_year - 2012)*12 + (book_month - 12))
        append_0 = max(append_0,1)
        append_1 = (pow(math.log(append_0), 1.35) * (-0.1+0.95*pow(append_0, 1.46)) * (3.5 + 17.6*is_booking))
        append_2 = cnt*(3 + 5.56*is_booking)
