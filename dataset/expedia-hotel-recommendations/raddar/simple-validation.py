...
def run_solution():
    ...
    while 1:
        ...
        append_0 = ((book_year - 2012)*12 + book_month)*cnt
        append_1 = (((book_year - 2012)*12 + (book_month - 12)) *  (3 + 12*is_booking))*cnt
        append_2 = (3 + 5*is_booking)*cnt
        ...
        popular_hotel_cluster[hotel_cluster] += cnt
