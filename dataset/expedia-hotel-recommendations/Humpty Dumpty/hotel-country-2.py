...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if user_location_city != '' and orig_destination_distance != '' and hotel_country != ''  and hotel_market !='':
            s1 = (user_location_city, orig_destination_distance, hotel_country, hotel_market)
