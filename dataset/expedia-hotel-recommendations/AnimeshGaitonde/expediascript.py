...
featurelist = ['user_id','user_location_city','srch_destination_id','hotel_continent','srch_ci']
whlist = ['user_id','user_location_city','srch_destination_id','hotel_continent','srch_ci','hotel_cluster']
...
RFclf = RandomForestClassifier(n_estimators=50,
    max_depth=12, random_state=0).fit(RFdata, RFpara['target'])
print('RFclf OK!')
