...
def run_solution():
    ...
    while 1:
        ...
        if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year != '' and hotel_continent != '':
            best_hotels_search_dest[(srch_destination_id, hotel_country, hotel_market,is_package,hotel_continent)][hotel_cluster] += append_1
    ...
    while 1:
        ...
        s2 = (srch_destination_id, hotel_country, hotel_market,is_package,hotel_continent)
