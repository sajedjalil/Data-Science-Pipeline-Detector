...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if srch_destination_id != '':
            sd1 = (srch_destination_id)
            if sd1 in best_hotels_search_dest1:
                if hotel_cluster in best_hotels_search_dest1[sd1]:
                    best_hotels_search_dest1[sd1][hotel_cluster] += append_2
                else:
                    best_hotels_search_dest1[sd1][hotel_cluster] = append_2
            else:
                best_hotels_search_dest1[sd1] = dict()
                best_hotels_search_dest1[sd1][hotel_cluster] = append_2
    ...
    f.close()
    return best_s00,best_s01, best_hotels_country, best_hotels_od_ulc, best_hotels_uid_miss, best_hotels_search_dest, best_hotels_search_dest1, popular_hotel_cluster


def gen_submission(best_s00, best_s01,best_hotels_country, best_hotels_search_dest, best_hotels_search_dest1, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster):
    ...
    while 1:
        ...
        sd1 = (srch_destination_id)
        if sd1 in best_hotels_search_dest1:
            d = best_hotels_search_dest1[sd1]
    ...
    print('Total d: {} ...'.format(totald))
    print('Total 2: {} ...'.format(total2))
    print('Total 3: {} ...'.format(total3))
    print('Total 4: {} ...'.format(total4))


best_s00,best_s01,best_hotels_country, best_hotels_od_ulc, best_hotels_uid_miss, best_hotels_search_dest, best_hotels_search_dest1, popular_hotel_cluster = prepare_arrays_match()
gen_submission(best_s00, best_s01,best_hotels_country, best_hotels_search_dest, best_hotels_search_dest1, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster)
