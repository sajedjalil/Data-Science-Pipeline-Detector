...
def run_solution():
    ...
    best_user_id = defaultdict(lambda: defaultdict(int))
    ...
    while 1:
        ...
        append_1 = ((book_year - 2012)*12 + book_month) * (10 + 10*is_booking)
        append_2 = ((book_year - 2012)*12 + book_month) * (10 + 5*is_booking)
        ...
        if user_id != '':
            best_user_id[user_id][hotel_cluster] += append_1
    ...
    while 1:
        ...
        if s2 in best_hotels_search_dest:
            ...
            d1 = best_user_id[srch_destination_id]
            for i in d:
                d[i] *= d1[i]
        ...
        d = best_user_id[srch_destination_id]
        topitems = nlargest(5, d.items(), key=itemgetter(1))
