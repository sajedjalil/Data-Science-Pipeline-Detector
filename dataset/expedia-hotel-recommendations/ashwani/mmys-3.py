...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if user_location_city != '' and orig_destination_distance != '' and user_id !='' and srch_destination_id != '' and is_booking==1:
            s01 = (user_id, srch_destination_id, hotel_country, hotel_market,orig_destination_distance)
            if s01 in best_s01:
...
def gen_submission(best_s01,best_hotels_country, best_hotels_search_dest, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster):
    ...
    while 1:
        ...
        s00 = (user_id, user_location_city, srch_destination_id, hotel_country, hotel_market,orig_destination_distance)
        s01 = (user_id, srch_destination_id, hotel_country, hotel_market,orig_destination_distance)
        if s01 in best_s01:
            d = best_s01[s01]
            topitems = nlargest(4, sorted(d.items()), key=itemgetter(1))
...
gen_submission(best_s01,best_hotels_country, best_hotels_search_dest, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster)
