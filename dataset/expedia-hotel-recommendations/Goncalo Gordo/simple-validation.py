...
def run_solution():
    ...
    while 1:
        ...
        ci_month = int(arr[11][5:7]) if arr[11] else 0
        season = math.ceil(int(ci_month)/3) 
        ...
        if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year != '' and season != 0:
            best_hotels_search_dest[(srch_destination_id, hotel_country, hotel_market, season)][hotel_cluster] += append_1
    ...
    while 1:
        ...
        if validate == 1:
            ...
            id = arr[0]
            ci_month = int(arr[12][5:7]) if arr[12] else 0
            season = math.ceil(int(ci_month)/3)
        ...
        s2 = (srch_destination_id, hotel_country, hotel_market, season)
