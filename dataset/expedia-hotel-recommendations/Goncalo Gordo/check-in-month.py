...
def prepare_arrays_match():
    ...
    while total  < 37000000:
        ...
        user_id = arr[7]
        is_package = arr[9]
        ci_month = int(arr[11][5:7]) if arr[11] else ''
        ...
        if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and ci_month != '':
            s2 = (srch_destination_id,hotel_country,hotel_market,is_package,ci_month)
...
def gen_submission(best_s00, best_s01,best_hotels_country, best_hotels_search_dest, best_hotels_od_ulc, best_hotels_uid_miss, popular_hotel_cluster):
    ...
    while 1:
        ...
        user_id = arr[8]
        is_package = arr[10]
        ci_month = int(arr[12][5:7]) if arr[12] else ''
