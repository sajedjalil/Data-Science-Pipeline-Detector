...
def run_solution():
    ...
    while 1:
      ...
      #  if user_location_region != '' and orig_destination_distance != '':
      #      best_hotels_od_ulc[(user_location_region, orig_destination_distance)][hotel_cluster] += 1
    ...
    #    s1 = (user_location_region, orig_destination_distance)
