...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if arr[11] != '' and arr[0] != '':
            ...
            b_day = int(arr[0][8:9])
        with_time = 0 if (in_day - b_day) > 1 or (in_month - b_month) > 1 or [(in_month - b_month) > -11 and (in_month - b_month) < 0] or [[(in_month - b_month) == -11 or (in_month - b_month) == 1] and (in_day - (b_day - 31)) > 1] else 1
