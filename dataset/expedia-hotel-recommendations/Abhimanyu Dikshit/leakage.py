...
def run_solution():
    ...
    while 1:
        ...
        book_month = int(int(arr[0][5:7])/6)
        # print(book_month)
        ...
        if user_location_city != '' and orig_destination_distance != '':
            best_hotels_od_ulc[(user_location_city, orig_destination_distance,book_month)][hotel_cluster] += 1
    ...
    while 1:
        ...
        s1 = (user_location_city, orig_destination_distance,book_month)
