...
def run():
    ...
    while 1:
        ...
        if user_location != '' and srch_destination_deistance != '' and user_id !='' and srch_destination_id != '' and hotel_country != '' and is_booking==1:
            s00 = (user_id, user_location, srch_destination_id, hotel_country, hotel_market)
            if s00 in best_s00:
                pass
            else:
                best_s00[s00] = dict()
        ...
        if user_location != '' and srch_destination_deistance == '' and user_id !='' and srch_destination_id != '' and hotel_country != '' and is_booking==1:
            s0 = (user_id, user_location, srch_destination_id, hotel_country, hotel_market)
