...
folders=os.listdir("../input/train/")
folders.remove(".DS_Store")
list_images=[]
for i in range(len(folders)):
    start=folders[i]
    for j in range(len(os.listdir("../input/train/"+folders[i]))):
        list_images.append(start+'_'+os.listdir("../input/train/"+folders[i])[j][4:])
...
features, _ = extract_features(list_images)
