...
def create_model():
    ...
    model.add(Dropout(0.51485))
    model.add(Dense(16, activation='relu',init='he_uniform' ,W_regularizer=l2(0.0015)))
    model.add(Dropout(0.51485))
    model.add(Dense(8, activation='softmax'))

    sgd = SGD(lr=0.996e-2, decay=1.002e-6, momentum=0.898, nesterov=True)
