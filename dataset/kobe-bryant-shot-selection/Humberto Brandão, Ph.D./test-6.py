...
clf_xgb = XGBClassifier(max_depth=6, learning_rate=0.012, n_estimators=1000, subsample=0.62, colsample_bytree=0.6, seed=1)
clf_xgb.fit(X, y)
...
submission.to_csv("submissson6.csv",index=False)
