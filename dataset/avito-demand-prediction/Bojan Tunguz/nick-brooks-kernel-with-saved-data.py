# I decided to create a version of Nick Brooks Kernel that will save all the data (train, test, y, feature names, val prediction).
# This could save time for future experimentation, in kernels and otherwise. 
...
save_npz("X.npz", X)
save_npz("testing.npz", testing)
np.save("y", y)

tfvocab_df = pd.DataFrame({"tfvocab":tfvocab})

tfvocab_df.to_csv("tfvocab_df.csv", index=False)
