...
train1 = train
train1.loc[(train1['y'] > 120) | (train1['y'] <80)]
train1M = train1
train1M['y'] = train1M['y'] - 1
train1P = train1
train1P['y'] = train1P['y'] + 1
train = pd.concat([train,train1M,train1P])
...
df_sub.to_csv('submission-svm2.csv', index=False)