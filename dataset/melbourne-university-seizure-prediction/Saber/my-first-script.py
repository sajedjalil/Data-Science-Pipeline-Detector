...
def main():
    ...
    # dftrain = process_matlab_files(['train_1', 'train_2', 'train_3'], train=True, train_images=train.image.values)
    # dftrain.to_csv('train_features3.csv', index=False)
    # train = train.merge(dftrain, how='left', left_on='image', right_on='image')
