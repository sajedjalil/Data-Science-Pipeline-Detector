...
id_test = test.id
train.loc[(train['full_sq']>=train['full_sq'].quantile(0.98)) & (train['price_doc']>=train['price_doc'].quantile(0.98)), 'price_doc']=train.loc[(train['full_sq']>=train['full_sq'].quantile(0.98)) & (train['price_doc']>=train['price_doc'].quantile(0.98)), 'price_doc']*1.02
...
train.loc[10089, 'build_year']=2005
train.loc[10090, 'build_year']=2009
train.loc[train.build_year>2020, 'build_year']=train.build_year.mean()
