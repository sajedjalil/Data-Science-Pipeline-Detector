...
print(len(test['id'].values))
print(len(test.columns))
y_train = train["price_doc"] * mult + 10.5
...
num_boost_rounds = 350  # This was the CV output, as earlier version shows
...
y_train = df_train['price_doc'].values * mult + 10.5
id_test = df_test['id']
...
num_boost_round = 400  # From Bruno's original CV, I think
