...
bad_index = train[((np.log1p(train.price_doc.values)/np.log1p(train.full_sq.values))<3)&(train.full_sq>200)].index
train.ix[bad_index, "full_sq"] = np.NaN
train.ix[bad_index, "life_sq"] = np.NaN
...
train = train[((np.log1p(train.price_doc.values)/np.log1p(train.full_sq.values))<5.5)]
train = train[((np.log1p(train.price_doc.values)/np.log1p(train.full_sq.values))>2.7)]
