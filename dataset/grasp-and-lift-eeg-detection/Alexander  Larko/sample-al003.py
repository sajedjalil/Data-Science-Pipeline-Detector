...
for subject in subjects:
    ...
    rf = RandomForestClassifier(n_estimators=10, n_jobs=-1, criterion="entropy", random_state=11)
    ...
    for i in range(6):
        ...
        rf.fit(X_train[::subsample,:],y_train[::subsample])
        X_train1 = X_train[::subsample,:]
        print('Train_sub  %d' % (X_train1.shape[0]))
...
# submission file
submission_file = 'Sample_AL003.csv'
