# version: 2019-08-08 22:55:10 start
...
def utils_prepare_parser():
  ...
  parser.add_argument(
    '--experiment_name', type=str, default='i96_ch24_hinge_ema_dstep1_bs32_noatt_glr0001_glr0006_aug_init_ortho_blur_style_origin_crop_mode3_on_kaggle',
  ...
  parser.add_argument(
    '--crop_mode', type=int, default=3, help='0:None '
                                            '1:max_crop '
                                            '2:max crop + origin '
...
# version: 2019-08-08 22:55:10 end