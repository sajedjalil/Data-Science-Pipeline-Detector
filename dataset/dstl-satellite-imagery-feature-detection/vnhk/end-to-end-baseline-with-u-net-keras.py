...
if __name__ == '__main__':
    x_val, y_val = stick_all_train()
    x1_val, y1_val = make_val(x_val, y_val)
    model = train_net(x_val, y_val, x1_val, y1_val)
    score, trs = calc_jacc(model, x1_val, y1_val)
