...
L1 = 0.6    # L1 regularization, larger value means more regularized
L2 = 0.4     # L2 regularization, larger value means more regularized
...
holdout = 9  # use every N training instance for holdout validation
