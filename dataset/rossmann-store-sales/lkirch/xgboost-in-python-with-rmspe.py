...
# thank you to justdoit
# first run was as is to get a feel for the script
# subsequent runs parameter tuning
...
submission.to_csv("xgboost_kscript_submission4.csv", index=False)
