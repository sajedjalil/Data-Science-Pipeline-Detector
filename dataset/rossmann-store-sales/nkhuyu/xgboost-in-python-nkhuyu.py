...
train = train[(train['Open']==1)&(train['Sales']>500)]
...
clf = xgb.train(param, dtrain, 3000, watchlist,feval=evalerror)
...
test[['Id', 'Sales']].to_csv("submission_nkhuyu_seed_100.csv", index = False)