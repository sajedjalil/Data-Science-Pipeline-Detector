...
population.nRound=[randint(250,300) for p in range(0,popSize)] #quick test
population.eta=[random.uniform(0.0015, 0.0010) for p in range(0,popSize)]
...
population.colsample_bytree=[random.uniform(0.5, 0.8) for p in range(0,popSize)]
