...
def create_model(img_rows, img_cols):
    ...
    sgd = SGD(lr=5e-4, decay=.7e-6, momentum=0.9, nesterov=True)
...
def run_cross_validation():
    ...
    yfull_train = np.empty((train_data.shape[0], 2))
    yfull_test = []
