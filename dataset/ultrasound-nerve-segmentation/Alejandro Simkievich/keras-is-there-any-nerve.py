...
def run_cross_validation(nfolds=4):
    ...
    #yfull_train = dict()
    #yfull_test = []
    #kf = KFold(len(train_data), n_folds=10, shuffle=True, random_state=random_state)
    #num_fold = 0
    #sum_score = 0
    ...
    #    print('length of train target',len(train_target))
    ...
    #    predictions_valid = model.predict(X_valid, batch_size=batch_size, verbose=1)
     ...
     #   print('prediction valid 0',predictions_valid[0])
     #   print('prediction valid 1',predictions_valid[1])
