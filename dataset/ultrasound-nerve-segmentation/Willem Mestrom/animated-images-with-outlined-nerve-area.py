...
def get_patient_images():
    ...
    f_ultrasounds = [f for f in glob.glob(f_path) if 'mask' not in f][:1000]
    print(f_ultrasounds)
...
def build_gif(imgs, fname, show_gif=True, save_gif=True, title=''):
    ...
    #fig = plt.figure(figsize=(29, 21), dpi=20)
...
def write_patient_video():
    ...
    write_gif(f_seq, images_masks, 'patient.gif')
...
def main():
    ...
    #for p in range(1, 48):
    #    write_patient_video(patient=p)
    write_patient_video()
    #write_patient_video(patient=5)
    #write_patient_video(patient=6)
    #write_patient_video(patient=7)
    #write_patient_video(patient=8)
    #write_patient_video(patient=9)
    #write_patient_video(patient=10)
