...
X_train, X_test, y_train, y_test = \
  cross_validation.train_test_split(X_sel, y, random_state=1301, stratify=y, test_size=0.2)
...
test['PCA3'] = test_pca[:,2]
test['PCA4'] = test_pca[:,3]
test['PCA5'] = test_pca[:,4]
test['PCA6'] = test_pca[:,5]
