...
if __name__ == "__main__":
    ...
    train_1=np.random.poisson(train.var15.mean(),train.var15[train['TARGET']==1].count())
    train_0=np.random.poisson(train.var15.mean(),train.var15[train['TARGET']==0].count())
