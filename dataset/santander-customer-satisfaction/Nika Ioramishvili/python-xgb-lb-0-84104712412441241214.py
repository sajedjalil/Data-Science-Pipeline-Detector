...
if __name__ == "__main__":
    ...
    train_1=np.random.poisson(new_train_1.sum()/new_train_1.count()-5,train.var15[train['TARGET']==1].count())
    train_0=np.random.poisson(new_train_0.sum()/new_train_0.count()+5,train.var15[train['TARGET']==0].count())
