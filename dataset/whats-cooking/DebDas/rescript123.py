...
clf=RandomForestClassifier(n_estimators=200,verbose=1,n_jobs=-1,min_samples_split=2,random_state=0)#(n_estimators=20,verbose=1,n_jobs=-1,min_samples_split=2,random_state=0) 
