...
#print(targets_tr.head(5))

alg=GradientBoostingClassifier(random_state=1, n_estimators=5, max_depth=3)


alg = alg.fit(predictors_tr, targets_tr)
test_predictions = alg.predict(predictors_ts)

testdf['cuisine'] = test_predictions
