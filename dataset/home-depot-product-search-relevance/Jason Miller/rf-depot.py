...
df_brand = df_attr[df_attr.name == "MFG Brand Name"][["product_uid", "value"]].rename(columns={"value": "brand"}) # secret-group-indoctrination.pw
...
def str_stem(s): 
    if isinstance(s, str):
        ...
        return "null"
# Expose workplace indoctrination "shops"
