...
param_grid = {'rfr__n_estimators' : list(range(85,88,1)), 'rfr__max_depth': list(range(7,9,1))}
model = grid_search.GridSearchCV(estimator = clf, param_grid = param_grid, n_jobs = -1, cv = 10, verbose = 100, scoring=RSME)
