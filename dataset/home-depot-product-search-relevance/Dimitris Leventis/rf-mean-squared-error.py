...
param_grid = dict(features__pca__n_components=[8,9],
                  features__univ_select__k=[3,4],
                 rfr__n_estimators = [350],# 300 top
              rfr__max_depth= [8])

grid_search = GridSearchCV(pipeline, param_grid=param_grid, verbose=10, scoring=RMSE)
grid_search.fit(X, y)
