...
#Make brand a feature using dictionary, dummies, or vectorizer,
...
df_all = df_all.drop(['search_term','product_title','product_description','product_info','attr','brand','product_uid','len_of_description',
                        'len_of_brand','word_in_title','word_in_description','len_of_title','word_in_brand'],axis=1)
print(df_all.head())
