...
rfr = RandomForestRegressor(n_estimators = 225, n_jobs = -1, random_state = 2016, verbose = 1) #incresing no. of estimators improves results but fun is staying within 20 min (2 cores) Kaggle limits which is 3x slower than my i7 device (~6.5 min)
...
model = grid_search.GridSearchCV(estimator = clf, param_grid = param_grid, n_jobs = -1, cv = 2, verbose = 25, scoring=RMSE)
