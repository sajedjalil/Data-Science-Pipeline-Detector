#please kaggle make it default in every competition!! from: https://www.kaggle.com/inversion/leaderboard-progression
...
file_name = '../input/webtraffic1/web-traffic-time-series-forecasting_public_leaderboard.csv' 
...
print("Data file loaded: ",np.shape(scores),", ",scores.columns,", ",file_name)
...
print("Running animation, frames:",len(dates_dict))
