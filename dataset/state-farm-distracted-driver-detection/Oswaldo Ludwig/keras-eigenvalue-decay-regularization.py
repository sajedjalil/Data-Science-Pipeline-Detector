...
#****************************************************************************************************************************
#Eigenvalue Decay regularizer can be downloaded at GitHub: https://github.com/oswaldoludwig/Eigenvalue-Decay-Regularizer-for-Keras
#****************************************************************************************************************************
...
def create_model_v1(img_rows, img_cols, color_type=1):
    ...
    model.add(Flatten())
    model.add(Dense(128,W_regularizer=EigenvalueRegularizer(0.1))) #Applying Eigenvalue Decay with C=0.1
    model.add(Activation('relu'))
...
def run_single():
    ...
    batch_size = 32
    nb_epoch = 36 # more training epochs for the regularized model
    random_state = 51
