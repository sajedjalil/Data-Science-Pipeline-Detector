...
# This script is part 4 of 4, for computing in 1200 sec.
...
list_abthpath = list_abthpath[6750:]
...
pandas.DataFrame(pandas_data, columns = pandas_header).to_csv('check_all_dataset_4.csv', index=False)
