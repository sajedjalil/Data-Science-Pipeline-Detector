...
# This script is part 2 of 4, for computing in 1200 sec.
...
list_abthpath = list_abthpath[2250:4500]
...
pandas.DataFrame(pandas_data, columns = pandas_header).to_csv('check_all_dataset_2.csv', index=False)
