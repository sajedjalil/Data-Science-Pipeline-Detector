...
import os 
#https://www.kaggle.com/hengck23/notebookf3b99a8d3d

#data_dir = '/root/share1/kaggle/2020/moa/data'
...
if 1:
    #csv_file = '/root/share1/kaggle/2020/moa/result/xxx/submit/remote/cnn_submission.csv' 
    csv_file ='../input/moadummy/blend1.csv'
...
print(df_submit)
print(df_submit.shape) # public [3982 rows x 206 columns]
