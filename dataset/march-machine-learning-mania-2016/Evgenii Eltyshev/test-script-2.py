...
if __name__ == "__main__":
    ...
    # max1, max2 = 1000, 1000
    # for i in np.linspace(1, 1.5, 1000):
    #     logloss = log_loss(trainlabels, np.clip(predictions.values*i, 1e-6, 1-1e-6))
    #     if logloss < max1:
    #         max1 = logloss
    #         max2 = i
    # print(max1, max2)
    ...
    submission = pd.DataFrame({'Id': testids,
                              'Pred': np.clip(predictions.values*1.00131313, 1e-6, 1-1e-6)})
