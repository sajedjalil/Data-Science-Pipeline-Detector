...
print("CPU %d" % multiprocessing.cpu_count())

print(lgb.__version__)
print(lgb.__file__)

print(check_output(["ls", "-l", "/opt/conda/lib/python3.6/site-packages/lightgbm-0.2-py3.6.egg/lightgbm/lib_lightgbm.so"]).decode("utf8"))
