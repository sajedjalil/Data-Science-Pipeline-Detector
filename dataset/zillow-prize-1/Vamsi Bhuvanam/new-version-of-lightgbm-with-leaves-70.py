...
print('Reading the data from Properties and Training CSV')
...
watchlist = [d_valid]
clf = lgb.train(params, d_train, 491, watchlist)

del d_train, d_valid; gc.collect()
del x_train, x_valid; gc.collect()

print("Prediction Preparation")
...
#p_test = clf.predict(x_test, num_iteration=gbm.best_iteration)
