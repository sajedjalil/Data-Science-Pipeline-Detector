# -*- coding: utf-8 -*-
"""
Created on Fri Sep 29 14:51:06 2017

@author: darshan
credits: https://www.kaggle.com/aharless/xgboost-lightgbm-and-ols
"""
'
# Parameters
XGB_WEIGHT = 0.641500
BASELINE_WEIGHT = 0.005359266
...
submission.to_csv('sub398_{}.csv'.format(datetime.now().strftime('%Y%m%d_%H%M%S')), index=False)
