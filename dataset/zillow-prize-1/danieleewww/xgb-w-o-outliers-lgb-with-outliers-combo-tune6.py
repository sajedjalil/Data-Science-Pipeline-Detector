...
x_test = properties.drop(['parcelid','fireplacecnt','fireplaceflag'], axis=1)
# shape        
...
x_train=train_df.drop(['parcelid', 'logerror','transactiondate','fireplacecnt','fireplaceflag'], axis=1)
