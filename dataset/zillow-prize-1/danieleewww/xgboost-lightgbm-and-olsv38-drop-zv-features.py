...
# drop ZV feautures LB=0.0645401
# version 38 LB=0.0644081
#    Try two XGB fits averaged

# version 37
#    Shot in the dark: num_boost_rounds=250 for XGB

# version 36
#    Back to 0.6300, and set num_boost_rounds per CV

# version 34
#    Try XGB_WEIGHT = 0.6315
...
x_train = df_train.drop(['parcelid', 'logerror', 'transactiondate', 'propertyzoningdesc', 
                        'propertycountylandusecode', 'buildingclasstypeid', 'decktypeid', 'poolcnt', 
                        'pooltypeid10', 'pooltypeid2', 'pooltypeid7', 'storytypeid', 'assessmentyear'], axis=1)
...
num_boost_rounds = 260
print("num_boost_rounds="+str(num_boost_rounds))

# train model again (but we shouldn't have to do this:  look at doc later to see if it saves)
