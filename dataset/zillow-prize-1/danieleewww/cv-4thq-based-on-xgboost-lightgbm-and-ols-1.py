####
# modified https://www.kaggle.com/robertoruiz/cv-4thq-based-on-xgboost-lightgbm-and-ols?scriptVersionId=1406257
# for full submission prediction
...
sub['parcelid'] = sub['ParcelId']
df_test = sub.merge(prop, on='parcelid', how='left')
...
df_test = df_test.drop(['parcelid', 'propertyzoningdesc', 
...
print('Writing csv ...')
sub.to_csv('4qxgblgbmols_cromagnon.csv', index=False, float_format='%.4f') # Thanks to @inversion
"""
#####
#Version 1: 0.064840
