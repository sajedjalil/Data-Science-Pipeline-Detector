# Parameters
FUDGE_FACTOR = 1.1500  # Multiply forecasts by this
...
prop17 = prop17.drop(['taxvaluedollarcnt','structuretaxvaluedollarcnt','landtaxvaluedollarcnt',
                        'taxamount','assessmentyear','taxdelinquencyflag','taxdelinquencyyear'],axis=1)
                        
prop =pd.concat([prop16, prop17])
train = pd.concat([train16, train17])
...
df_test = sample.merge(prop16, on='parcelid', how='left')
print("   ...")
...
properties16 = pd.read_csv('../input/properties_2016.csv')
properties17 = pd.read_csv('../input/properties_2017.csv')

properties17 = properties17.drop(['taxvaluedollarcnt','structuretaxvaluedollarcnt','landtaxvaluedollarcnt',
                        'taxamount','assessmentyear','taxdelinquencyflag','taxdelinquencyyear'],axis=1)

properties = pd.concat([properties16, properties17])
...
properties =pd.concat([prop16, prop17])
train = pd.concat([train16, train17])
