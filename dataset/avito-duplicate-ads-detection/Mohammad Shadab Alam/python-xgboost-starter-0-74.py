...
def run_default_test(train, test, features, target, random_state,split):
    eta = 9
    max_depth = 5
    subsample = 0.8
...
test_prediction1, score = run_default_test(train, test, features, 'isDuplicate',0,0.1)
test_prediction2, score = run_default_test(train, test, features, 'isDuplicate',1,0.3)
print('Real score = {}'.format(score))
myList = [sum(x) for x in zip(test_prediction1, test_prediction2)]
myInt = 2
newList = [x / myInt for x in myList]
create_submission(score, test, newList)
