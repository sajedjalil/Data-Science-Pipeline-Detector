...
def xgboost_pred(train,labels,test,seed):
	params = {}
...
preds1 = xgboost_pred(train_s,labels,test_s,13)
for k in [2,343,23423,123,234,553,2313]:
    preds1 += xgboost_pred(train_s,labels,test_s,k)
#model_2 building
...
preds2 = xgboost_pred(train,labels,test, 218)
for k in [2,343,23423,123,234,553,2313]:
    preds2 += xgboost_pred(train,labels,test,k)
