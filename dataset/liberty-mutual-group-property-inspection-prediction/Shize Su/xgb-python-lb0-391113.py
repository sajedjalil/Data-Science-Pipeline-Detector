...
#np.savetxt('trains_xgb_LB0.391113.csv', train_s, delimiter=',')

#np.savetxt('tests_xgb_LB0.391113.csv', test_s, delimiter=',')

#np.savetxt('labels_xgb_LB0.391113.csv', labels, delimiter=',')
...
#print (train[1:4,1:60])
print(train.shape)

train=train.toarray()
test=test.toarray()

#x_train = np.hstack((train,labels ))
#x_train = x_train.astype(float)
#np.savetxt('train_xgb_LB0.391113.csv', train, delimiter=',')
np.savetxt('test_xgb_LB0.391113.csv', test, delimiter=',')
...
#print (xgtrain[1:4,1:20])
#print(xgtrain.shape)
#xgtrain=np.array(xgtrain)
...
#np.savetxt('train_xgb_LB0.391113.csv', x_train, delimiter=',')
...
#preds.to_csv('xgboost_benchmark_kk_LB0.391113.csv')