...
preds.to_csv('xgboost_benchmark_kk-eta0.0055_preds1.csv')
...
preds = pd.DataFrame({"Id": test_ind, "Hazard": preds})
preds = preds.set_index('Id')
preds.to_csv('xgboost_benchmark_kk-eta0.0055_preds2.csv')
...
preds = pd.DataFrame({"Id": test_ind, "Hazard": preds})
preds = preds.set_index('Id')
preds.to_csv('xgboost_benchmark_kk-eta0.0055.csv')