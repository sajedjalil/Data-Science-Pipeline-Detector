...
corrdata = pd.read_csv("../input/train.csv",usecols=[1,2,3,4,11,14,15,19,20,22,24,25,26,27,28,32,33])
...
rel_cols = ['T1_V1', 'T1_V2', 'T1_V3', 'T1_V10', 'T1_V14', 'T2_V1', 'T2_V2', 'T2_V4', 'T2_V6', 'T2_V8', 'T2_V9', 'T2_V10', 'T2_V14', 'T2_V15']
x_num_data = data[rel_cols].as_matrix()
x_num_test = test[rel_cols].as_matrix()
...
model = KNeighborsClassifier(n_neighbors=8, p=1, leaf_size=40)
