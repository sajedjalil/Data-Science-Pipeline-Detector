'''
Modified from 'Blah - XGB' Script to calculate predictions on training data
so that they can be used in ensembles to determine best weighting.
...
def xgboost_pred(train,labels,test):
	...
	num_rounds = 2000
	# Change function to predict back on to Training Data
...
preds = pd.DataFrame({"Hazard": preds})
preds.to_csv('xgboost_benchmark_kk_train.csv')