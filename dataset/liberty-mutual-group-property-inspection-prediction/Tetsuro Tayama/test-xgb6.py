...
offset_tmp = 10000
train_s_tmp1 = train_s[offset_tmp:,:]
train_s_tmp2 = train_s[:offset_tmp,:]

#train_s_tmp1 = train_s_tmp1[::-1,:]
#train_s_tmp2 = train_s_tmp2[::-1,:]

train_s = np.r_[train_s_tmp2, train_s_tmp1]
...
preds.to_csv('xgboost_benchmark_6.csv')
