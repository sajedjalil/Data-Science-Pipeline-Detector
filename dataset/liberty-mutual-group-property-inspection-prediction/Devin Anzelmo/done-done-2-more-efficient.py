'''
xgboost is currently deterministic if ran on the same dataset multiple times it will produce the same results each time.
There are several scripts where people are doing 7+ runs of the same model. 
This script illustrates how the same thing can be achieved by multipling preds2 by 7. 

I also added the option to change the random seed. 
...
#change this to change the random seed, will need to do it between runs of xgboost to get different results. 
params["seed"] = 0
