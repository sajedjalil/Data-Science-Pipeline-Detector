...
preds1 = xgboost_pred(train_s,labels,train_s)
...
preds2 = xgboost_pred(train,labels,train)
...
#generate solution
preds = pd.DataFrame({"Id": train_ind, "Hazard": preds})
preds = preds.set_index('Id')
preds.to_csv('best_script_trainpreds.csv')