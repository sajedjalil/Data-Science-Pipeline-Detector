...
if __name__ == '__main__':
    ...
    score = normalized_gini(y_test_fold,y_pred_fold)  
    print ("gini score: %f" % (score))
    gini_scores.append(score)
    #gini_scores.append(y_pred_fold1)
    #gini_scores.append(y_pred_fold2)

gini_scores2=np.array(gini_scores)   
mean_ginis = []
for i in gini_scores2.T:
    print (np.mean(i))
