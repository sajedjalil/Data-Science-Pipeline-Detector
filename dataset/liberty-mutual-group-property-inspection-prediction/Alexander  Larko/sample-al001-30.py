...
def xgboost_pred(train,labels,test,m_d):
	params = {}
...
preds1 = xgboost_pred(train_s,labels,test_s,15)
...
preds2 = xgboost_pred(train,labels,test,15)
...
preds.to_csv('Sample_AL001_1.csv')