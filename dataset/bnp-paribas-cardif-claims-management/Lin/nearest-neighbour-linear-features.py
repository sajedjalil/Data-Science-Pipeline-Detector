...
rnd=12
random.seed(rnd)
n_ft=25 #Number of features to add
...
clf = ensemble.ExtraTreesClassifier(n_estimators=1000,max_features=50,criterion= 'entropy',min_samples_split= 4,
                       bootstrap = True , max_depth= 30, min_samples_leaf= 2, n_jobs = -1, random_state=rnd)
...
submission.to_csv('./NiceNNLinearFt.csv', index=False)
