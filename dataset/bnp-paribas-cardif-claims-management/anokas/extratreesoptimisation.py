...
extc = ExtraTreesClassifier(n_estimators=700,max_features= 70,criterion= 'entropy',min_samples_split= 2,
                            max_depth= 60, min_samples_leaf= 2, n_jobs = -1, verbose=3)      
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:,1]}).to_csv('predictions.csv',index=False)