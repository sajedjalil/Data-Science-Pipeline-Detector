...
X_test = test
print('Training...')
extc = ExtraTreesClassifier(n_estimators=1000,max_features= 30,criterion= 'entropy',min_samples_split= 2,
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:,1]}).to_csv('extra_trees_subfmarin.csv',index=False)