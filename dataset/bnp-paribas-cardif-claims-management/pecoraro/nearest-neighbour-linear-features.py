...
drop_list=['v91', 'v1', 'v8', 'v15', 'v17', 'v22', 'v25', 'v29', 'v34', 'v41', 'v46', 'v54', 'v64', 'v67', 'v97', 'v105', 'v111', 'v122']
...
a=addNearestNeighbourLinearFeatures(n_neighbours=25, max_elts=4, verbose=True, random_state=rnd)
a.fit(train[:10000], target[:10000])

train = a.transform(train)
test = a.transform(test)

clf = ensemble.ExtraTreesClassifier(n_estimators=700,max_features=50,criterion= 'entropy',min_samples_split= 4,
