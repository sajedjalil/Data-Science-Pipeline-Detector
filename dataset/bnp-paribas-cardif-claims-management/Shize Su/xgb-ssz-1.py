...
X_fit, X_eval, y_fit, y_eval= train_test_split(
    train, target, test_size=0.2, random_state=8
)
...
clf = xgb.XGBClassifier(missing=np.nan, max_depth=12, 
                        n_estimators=900, learning_rate=0.05, 
                        subsample=0.9, colsample_bytree=0.9, seed=8)
...
submission.to_csv("submission_xgb_ssz.csv", index=False)
