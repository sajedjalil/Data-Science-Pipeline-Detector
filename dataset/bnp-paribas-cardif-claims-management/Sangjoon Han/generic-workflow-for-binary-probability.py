...
clf = {'xgc':xgc, 'xgr':xgr} # removed due to kaggle performance, would prefer less time and more cores than more time and less cores :)
...
ds.to_csv('submission_Gen.csv',index=False)
