...
train = train.drop(['ID','target','v8','v23','v25','v31','v36',
...
test = test.drop(['ID','v8','v23','v25','v31','v36','v37','v46',
                  'v51','v53','v54','v63','v73','v75','v79','v81',
                  'v82','v89','v92','v95','v105','v107','v108',
...
sgd = SGDClassifier(loss="log", penalty="elasticnet", n_jobs = -1, n_iter = 400, random_state = 123)

model_calib = CalibratedClassifierCV(base_estimator=sgd, cv=7, method='isotonic')

model_calib.fit(X_train,target)

print ("Predict")
test_labels=model_calib.predict_proba(X_test)[:,1]

predictions_file = open("simple_sgd_result.csv", "w")
open_file_object = csv.writer(predictions_file)
open_file_object.writerow(["ID", "PredictedProb"])
open_file_object.writerows(zip(id_test,test_labels))
