# used https://www.kaggle.com/george04/dogs-vs-cats-redux-kernels-edition/cnn-cat-dog
# as reference and for algorithm.
...
model.fit(  X_train, Y_train, batch_size = 128, nb_epoch = 8, show_accuracy = True, verbose = 1, validation_data = (X_valid, Y_valid))
