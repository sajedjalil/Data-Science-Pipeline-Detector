...
#add date for adjustments 
date_of_interest = '2020-04-04'        
...
train = train.append(test[test['Date']>date_of_interest])
#fix dates
import datetime 
...
val = train[(train['Date']>='2020-03-27')&(train['Id'].isnull()==False)]
...
dates = dates[dates > date_of_interest]
dates
len(dates)
train.isnull().sum()
i = 0
...
test[test['Country_Region']=='Italy']
print(len(test))
train_sub = pd.read_csv("/kaggle/input/covid19-global-forecasting-week-3/train.csv")
...
#Run ARIMA Influenza Baselines
#https://www.kaggle.com/skeller/arima-influenza-baselines
