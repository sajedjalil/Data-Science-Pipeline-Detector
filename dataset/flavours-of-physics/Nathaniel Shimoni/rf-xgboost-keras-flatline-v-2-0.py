...
nb_train_sample = int(len(y) * 0.22) # used to be 0.97, 0.78 is better, 0.83 possible
...
# train model
model.fit(X_train, y_train, batch_size=128, nb_epoch=90, validation_data=(X_eval, y_eval), verbose=2, show_accuracy=True)
...
clf = UGradientBoostingClassifier(loss=loss, n_estimators=250, subsample=0.1, # n_estimators = 75
...
params = {"objective": "binary:logistic",
          ...
          "seed": 1}
num_trees=600 #used to be 300, 375 is better
