...
clf = UGradientBoostingClassifier(loss=loss, n_estimators=100, subsample=0.5, 
...
rf = RandomForestClassifier(n_estimators=300, n_jobs=-1, criterion="entropy", random_state=1, min_samples_leaf=100)
