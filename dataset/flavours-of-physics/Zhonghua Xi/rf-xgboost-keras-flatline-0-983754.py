...
# shuffle the data
np.random.seed(987) # used to be 369
np.random.shuffle(X)
np.random.seed(987)
np.random.shuffle(y)
...
clf = UGradientBoostingClassifier(loss=loss, n_estimators=128, subsample=0.1, # n_estimators = 75
...
rf = RandomForestClassifier(n_estimators=255, n_jobs=-1, criterion="entropy", random_state=1)
...
params = {"objective": "binary:logistic",
          ...
          "seed": 1}
num_trees=512 #used to be 300, 375 is better
