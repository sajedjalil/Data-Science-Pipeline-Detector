...
params = {"objective": "binary:logistic",
          ...
          "subsample": 0.7,
          "seed": 1}
num_trees=250 #used to be 300, 375 is better
...
test_probs = (0.5*rf.predict_proba(test[features])[:,1]) + (0.5*gbm.predict(xgb.DMatrix(test[features])))
...
submission.to_csv("rf_xgboost_1.csv", index=False)