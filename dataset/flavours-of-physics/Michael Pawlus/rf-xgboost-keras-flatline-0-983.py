...
clf = UGradientBoostingClassifier(loss=loss, n_estimators=100, subsample=0.1, # n_estimators = 75, 150 not bad
...
params = {"objective": "binary:logistic",
          ...
          "max_depth": 8, # used to be 5 or 6, 7 not bad
          "min_child_weight": 1,
          "silent": 1,
          "colsample_bytree": 0.7,
          "seed": 1}
num_trees=500 #used to be 300, 375 is better, 450 not bad
...
submission.to_csv("rf_xgboost_keras_flatness_b1.csv", index=False)