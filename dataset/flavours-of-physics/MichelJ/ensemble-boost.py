...
rf = UGradientBoostingClassifier(loss=loss, n_estimators=300,  
                                  ...
                                  learning_rate=0.17, train_features=features, subsample=0.85, random_state=317)
...
AUC2 = evaluation.roc_auc_truncated(train_eval['signal'], train_eval_probs_gbm)
print ('AUC XGB', AUC2)

#train_eval_probs_rf1 = rf1.predict_proba(train_eval[features])[:,1]
#AUC3 = evaluation.roc_auc_truncated(train_eval['signal'], train_eval_probs_rf1)
#print ('AUC RF', AUC3)
...
#train_eval_probs = 0.4*train_eval_probs_rf + 0.4*train_eval_probs_gbm + 0.2*train_eval_probs_rf1
#AUC = evaluation.roc_auc_truncated(train_eval['signal'], train_eval_probs)
