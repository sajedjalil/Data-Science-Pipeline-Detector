# coding: utf-8
__author__ = 'ixxra: https://kaggle.com/ixxra'

#NOTE: I was based on https://kaggle.com/ZFTurbo
...
def run_solution():
    ...
    while 1:
        ...
        if total_lines % 10000000 == 0:
            print('Read {} lines...'.format(total_lines))
    ...
    while 1:
        ...
        if total % 10000000 == 0:
            print('Write {} lines...'.format(total_lines))
