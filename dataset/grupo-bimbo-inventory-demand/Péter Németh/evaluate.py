...
print("Reading data")
train = pd.read_csv('../input/train.csv',usecols=['Cliente_ID','Producto_ID','Agencia_ID','Ruta_SAK','Demanda_uni_equil'],nrows=3000000)#DEBUG nrows
test  = pd.read_csv('../input/test.csv' ,usecols=['Cliente_ID','Producto_ID','Agencia_ID','Ruta_SAK'],nrows=30000)#DEBUG nrows
...
submit=submit.loc[:,['id','Demanda_uni_equil']]
