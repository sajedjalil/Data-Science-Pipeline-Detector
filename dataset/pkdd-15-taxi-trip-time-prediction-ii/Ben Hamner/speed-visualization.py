...
def add1ToEachPoint(image,data,border):
...
"""
I've splitted the training data into several (around 1500) smaller csv files
we will analyse the first 50 of these files.  
"""
...
for i in range(5000):
    ...
    if i%1000==999:
        ...
        image = add1ToEachPoint(image,data,[minlat,maxlon,maxlat,minlon])
        data = []
