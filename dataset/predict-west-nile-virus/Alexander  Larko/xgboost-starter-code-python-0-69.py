...
# build weather dic
fi = csv.reader(open("C:/West/Data/weather.csv"))
...
# build train dic
fi = csv.reader(open("C:/West/Data/train.csv"))
...
ids = []
fi = csv.reader(open("C:/West/Data/test.csv"))
...
num_round = 50
cv.nround = 150
bst.cv = xgb.cv(param, dtrain,5, cv.nround)
...
fo = csv.writer(open("submission1.csv", "w"), lineterminator="\n")
