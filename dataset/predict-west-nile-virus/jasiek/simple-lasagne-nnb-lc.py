...
def train():
    ...
    outX = csv.writer(open("train_data_X_v2.csv", "w"))
    for row in X:
        outX.writerow(row)
    
    outY = csv.writer(open("train_data_y_v2.csv", "w"))
    for row in y:
        outY.writerow(row)
...
def submit(net, mean, std):
    ...
    out = csv.writer(open("test_data_X_v2.csv", "w"))
    for row in X:
        out.writerow(row)
    ...
    #
    out = csv.writer(open("submission_v2.csv", "w"))
