...
for b in x:
    ...
    i+=1
h.append("}</script></head><body onload='GetMap();'><div id='myMap' style='position:relative; width:700px; height:650px;border:1px solid #000000;'></div></body></html>")
