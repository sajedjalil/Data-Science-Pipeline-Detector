# I think it is very unfortunate that Kaggle allows just anybody to use a late script that he/she/they
#    hasn't invested anything into.
#
# But in gamifying predictive modeling, they can't be surprised if people apply game strategies.
# And for me, that means recognizing that (1) my personal learning and (2) my scoring->KaggleRanking 
#    are two distinctly different things. 
#
# So this isn't my script (altho I made one tweak), but since it's demonstrably better than what 
#    I've done myself so far, it would be foolish of me to NOT spend 10 or whatever minutes by 
#    submitting it and improving my standing.
#  
# And then I can go back to cooking up my own recipe and getting better by really working the problem.
#   Signipinnis.
...
species_map = {'CULEX RESTUANS'        : "100",
              'CULEX TERRITANS'        : "001", 
              'CULEX PIPIENS'          : "010", 
              'CULEX PIPIENS/RESTUANS' : "110", 
              'CULEX ERRATICUS'        : "001", 
              'CULEX SALINARIUS'       : "001", 
              'CULEX TARSALIS'         : "001",
              'UNSPECIFIED CULEX'      : "100"} 
def date(text):
...
def assemble_X(base, weather):
    ...
    for b in base:
        ...
        for days_ago in [1,5,10,15,20,25]:
            ...
            for obs in ["Tmax","Tmin","Tavg","DewPoint","WetBulb","PrecipTotal","Depart","Sunrise","Sunset","Heat","Cool","AvgSpeed","ResultDir"]:
...
def submit(net, mean, std):
    ...
    #
    out = csv.writer(open("west_nile_v55044.csv", "w"))
