...
def assemble_X(base, weather):
    ...
    for b in base:
        ...
        for days_ago in [1,2,3,5,8,12]:
            ...
            for obs in ["Tmax","Tmin","Tavg","DewPoint","WetBulb","PrecipTotal","Depart","Sunrise","Heat","Cool"]:
...
#        ('dropout2', DropoutLayer),
    ...
    hidden1_num_units=input_size*5, 
#    dropout1_p=0.4,
#    hidden2_num_units=375, 
#    dropout2_p=0.4,
...
def submit(net, mean, std):
    ...
    #
    out = csv.writer(open("west_nile_v201.csv", "w"))
