...
def generator(data, min_index=0, max_index=None, batch_size=16, n_steps=150, step_length=1000):
    ...
    while True:
        ...
        temp_step_length=int((max_index-min_index-n_steps*step_length-150000)/(batch_size-1))
        for j in range(batch_size):
            row = min_index + n_steps * step_length + j*temp_step_length + i
...
def generator_initial(data, min_index=0, max_index=None, batch_size=16, n_steps=150, step_length=1000):
    if max_index is None:
        max_index = len(data) - 1
...
valid_gen = generator_initial(float_data, batch_size=16, max_index=second_earthquake)
