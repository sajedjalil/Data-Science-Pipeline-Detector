...
def GrabData():
    ...
    cols = [['Id',
            ...
            ['Id',
             ...
             'L3_S38_F3960', 'L1_S24_F1723',
             'L3_S38_F3956', 'L1_S24_F1846',
             'L3_S33_F3871', 'L1_S24_F1498',
             'L1_S24_F1609', 'L1_S24_F1632',
             'L1_S24_F1604', 'L1_S24_F867',
             'L2_S26_F3117', 'L3_S30_F3609',
             'Response']]
    traindata = None
    testdata = None
...
def Train():
    ...
    submission[['Id', 'Response']].to_csv('rawxgbsubmission'+str(folds)+'.csv',
                                          index=False)
    y_pred = (testpredictions/folds > (1 - best_proba)).astype(int)
    
    print('Number of 1s in prediction:', np.sum(y_pred))
    
    submission = pd.DataFrame({"Id": test.Id.values,
                               "Response": y_pred})
    submission[['Id', 'Response']].to_csv('xgbsubmission_'+str(folds)+'.csv',
                                          index=False)
