...
dtrain.save_binary("trainxgb.buffer") #Save the Matrix for later
print('Saved Matrix for later')
res = xgb.cv(xgb_params, dtrain, num_boost_round= ROUNDS, nfold=5, seed=0, stratified=True,
