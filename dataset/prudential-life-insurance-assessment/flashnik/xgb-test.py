...
print(xgb_num_rounds)
print(len(eta_list))
model = xgb.train(plst, xgtrain, xgb_num_rounds, evals=watchlist, early_stopping_rounds=250, learning_rates=eta_list) 

# get preds
train_preds = model.predict(xgtrain, ntree_limit=model.best_iteration)
q1 = rmse(train['Response'], train_preds)
print('RMSE Train score is:', q1) 
