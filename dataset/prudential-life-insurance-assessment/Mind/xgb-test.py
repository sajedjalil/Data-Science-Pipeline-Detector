...
all_data['BMI_Age_Sq'] = all_data['BMI_Age'] * all_data['BMI_Age']
all_data['BMI_1_Sq'] = (all_data['BMI'] + 1) * (all_data['BMI'] + 1)
all_data['BMI_08'] = all_data['BMI'] ** 0.8
all_data['IAge_85'] = all_data['Ins_Age'] ** 8.5
all_data['BMI_MK3'] = (all_data['BMI'] * all_data['Medical_Keyword_3'] + 0.5) ** 3.0
...
preds_out.to_csv('xgb_maxdepth10.csv')