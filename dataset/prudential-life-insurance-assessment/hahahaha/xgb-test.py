...
all_data['e.BMI.p1sq2'] = (all_data['BMI'] + 1.0) ** 2.0
all_data['e.BMI.sq08'] = all_data['BMI'] ** 0.8
all_data['e.Ins_Age.sq85'] = all_data['Ins_Age'] ** 8.5
all_data['e.BMI.x.Ins_Age.sq25'] = (all_data['BMI'] * all_data['Ins_Age']) ** 2.5
all_data['e.BMI.x.Product_Info_4.sq09'] = (all_data['BMI'] * all_data['Product_Info_4']) ** 0.9
all_data['e.BMI.x.Medical_Keyword_3.p05sq3'] = (all_data['BMI'] * all_data['Medical_Keyword_3'] + 0.5) ** 3
