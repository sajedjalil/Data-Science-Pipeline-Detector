...
trp = pd.DataFrame(train_preds)
tep = pd.DataFrame(test_preds)
trp.to_csv('train_preds_04.csv')
tep.to_csv('test_preds_04.csv')
...
preds_out.to_csv('xgb_offset_test04.csv')
