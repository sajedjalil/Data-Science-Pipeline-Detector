...
# global variables
columns_to_drop = ['Id', 'Response','Medical_History_10','Medical_History_24','Family_Hist_3','Family_Hist_5','Medical_Keyword_1']
xgb_num_rounds = 800
num_classes = 8
eta_list = [0.05] * 200 
...
cols = ['Family_Hist_2','Family_Hist_3','Family_Hist_4','Family_Hist_5']
all_data[cols].fillna(0, inplace = True)
all_data['Family_Hist_2'] = all_data['Family_Hist_2'] + all_data['Family_Hist_3']
all_data['Family_Hist_4'] = all_data['Family_Hist_4'] + all_data['Family_Hist_5']
