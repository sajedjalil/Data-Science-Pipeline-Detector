...
ed_keyword_columns = all_data.columns[all_data.columns.str.startswith('Medical_History_')]
all_data['Medical_History_Count'] = all_data[med_keyword_columns].sum(axis=1)
