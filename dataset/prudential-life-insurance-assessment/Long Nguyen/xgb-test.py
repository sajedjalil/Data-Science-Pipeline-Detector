...
all_data['BMIdivAge'] = all_data['BMI'] / all_data['Ins_Age']
all_data['BMI_25'] = all_data['BMI'] < 25
all_data['30_BMI'] = all_data['BMI'] > 30
...
preds_out.to_csv('xgb_offset_submission_9.csv')