# -*- coding: utf-8 -*-
"""
Created on Thu Jan 12 18:22:12 2017
...
def evaluate3():
    ...
    #Logistic Regression - method_PP, method_F, method_A, OneVsRest, randomized, grid, calibrated
    
    algorithms = ["Logistic Regression-1", "Logistic Regression-2", "Logistic Regression-3", "Logistic Regression-4", "Logistic Regression-5", "Logistic Regression-6"]
    methods = ["Preprocessing", "Filtering", "Multiclass Strategy", "Model Selection", "Cross Validation", "Accuracy", "Rank Kaggle"]
    results = []
    table_final = pd.DataFrame(results,index=algorithms,columns=methods)
    """
    print("Evaluating Logistic Regression - 1 ")
    print("      ")
    
    #method_PP, method_F, method_A, OneVsRest, randomized, grid, calibrated
    
    accuracy,_ = write("normalization","univariance","logistic",False,True,False,False)

    results.append(["normalization","univariance",False,"Randomized","Normal",accuracy,0])
    print(accuracy)
    
    print("Evaluating Logistic Regression - 2 ")
    print("      ")
    
    #method_PP, method_F, method_A, OneVsRest, randomized, grid, calibrated
    accuracy,_ = write("normalization","univariance","logistic",False,False,False,True)
    results.append(["normalization","univariance",False,False,"Calibrated",accuracy,0])
    print(accuracy)
    
    print("Evaluating Logistic Regression - 3 ")
    print("      ")
    
    #method_PP, method_F, method_A, OneVsRest, randomized, grid, calibrated
    accuracy,_ = write("normalization","univariance","logistic",True,False,False,False)
    results.append(["normalization","univariance","OneVsRest",False,"Normal",accuracy,0])
    print(accuracy)
    
    print("Evaluating Logistic Regression - 4 ")
    print("      ")
    
    #method_PP, method_F, method_A, OneVsRest, randomized, grid, calibrated
    accuracy,_ = write("standardization","univariance","logistic",False,False,False,True)
    results.append(["standardization","univariance",False,False,"Calibrated",accuracy,0])
    print(accuracy)    
    print("Evaluating Logistic Regression - 5 ")
    print("      ")
    
    #method_PP, method_F, method_A, OneVsRest, randomized, grid, calibrated
    accuracy,name = write("standardization","univariance","logistic",False,False,True,False)
    results.append(["standardization","univariance",False,"Grid","Normal",accuracy,0])
    print(accuracy)    
    print("Evaluating Logistic Regression - 6 ")
    print("      ")
    
    #method_PP, method_F, method_A, OneVsRest, randomized, grid, calibrated
    accuracy,name = write("standardization","univariance","logistic",True,False,False,False)
    results.append(["standardization","univariance","OneVsRest",False,"Normal",accuracy,0])
    print(accuracy)
    """
    
    print("Evaluating Logistic Regression - 7 ")
    print("      ")
