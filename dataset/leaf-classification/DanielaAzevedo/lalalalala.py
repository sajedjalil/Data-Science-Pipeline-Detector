...
def write():
    ...
    probs = accuracies(method_PP = "standardization", method_F = "univariance", method_A = "svm", OneVsRest = False, OneVsOne = False, randomized = True, calibrated = False)
    yPred = pd.DataFrame(probs,index=ids,columns=species)
    print('Creating and writing submission...')
    fp = open('random_probs.csv', 'w')
    fp.write(yPred.to_csv())
    
accuracies(method_PP = "standardization", method_F = "univariance", method_A = "neural_networks", OneVsRest = False, OneVsOne = False, randomized = False, calibrated = False)
