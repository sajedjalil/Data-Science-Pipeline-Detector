...
phone_brand.phone_brand = phone_brand.phone_brand.map(pd.Series(english_chinese_mapping),na_action='ignore')

data = pd.merge(app_labels,label_categories,on="label_id")
