...
Xtrain = hstack((Xtr_brand, Xtr_model, Xtr_app, Xtr_label,Xtr_eventsize,Xtr_event_on_hourofday), format='csr')
Xtest =  hstack((Xte_brand, Xte_model, Xte_app, Xte_label,Xte_eventsize,Xte_event_on_hourofday), format='csr')
...
def baseline_model():
    # create model
    model = Sequential()
    model.add(Dense(20, input_dim=Xtrain.shape[1], init='normal', activation='relu'))
