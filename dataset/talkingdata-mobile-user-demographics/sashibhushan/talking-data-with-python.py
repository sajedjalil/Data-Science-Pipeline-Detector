...
events.info()
# remove of duplicated ids reduce the overall size of the data
...
#################################################################
#                            concatetination of all features
#################################################################
...
X_train, X_val, y_train, y_val = train_test_split(
    train_sp, Y, train_size=0.99, random_state=10)
...
result.to_csv('py1.csv', index=True, index_label='device_id')
