...
def baseline_model():
    ...
    model.add(Dense(40, input_dim=X_train.shape[1], init='normal', activation='softmax'))
    model.add(PReLU())
...
#result.to_csv('./sub23.csv', index=True, index_label='device_id')
#Drop out 0.2
#Validation 2.3156
result.to_csv('sub165.csv', index=True, index_label='device_id')
