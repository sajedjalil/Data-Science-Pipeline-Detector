...
test_prediction0, score = run_xgb(train, test, features, 'group', random_state=0)
test_prediction1, score1 = run_xgb(train, test, features, 'group', random_state=1)
test_prediction=(test_prediction0+test_prediction1)/2
