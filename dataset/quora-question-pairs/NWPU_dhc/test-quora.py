...
def main():
	...
	x['why'] = df['question1'].apply(lambda x: ("why" in str(x).lower()) * 1)*df['question2'].apply(lambda x: ("why" in str(x).lower()) * 1)
	x['Trump'] = df['question1'].apply(lambda x: ("Trump" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("Trump" in str(x).lower()) * 1)
	x['money'] = df['question1'].apply(lambda x: ("money" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("money" in str(x).lower()) * 1)
	x['India'] = df['question1'].apply(lambda x: ("India" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("India" in str(x).lower()) * 1)
	x['weight'] = df['question1'].apply(lambda x: ("weight" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("weight" in str(x).lower()) * 1)
	x['Clinton'] = df['question1'].apply(lambda x: ("Clinton" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("Clinton" in str(x).lower()) * 1)
	x['War'] = df['question1'].apply(lambda x: ("War" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("War" in str(x).lower()) * 1)
	x['best'] = df['question1'].apply(lambda x: ("best" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("best" in str(x).lower()) * 1)
	x['programming'] = df['question1'].apply(lambda x: ("programming" in str(x).lower()) * 1) * df['question2'].apply(lambda x: ("programming" in str(x).lower()) * 1)
