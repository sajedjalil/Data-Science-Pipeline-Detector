...
print('load train...')
train_df = pd.read_csv(path+"../input/train.csv", nrows=40000000, dtype=dtypes, usecols=['ip','app','device','os', 'channel', 'click_time', 'is_attributed'])
print('load test...')
...
print("writing...")
sub.to_csv('sub_lgb_balanced100.csv',index=False)
print("done...")
print(sub.info())