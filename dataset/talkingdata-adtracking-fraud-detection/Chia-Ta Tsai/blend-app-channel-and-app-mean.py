...
w_ac  = 0.6
w_a   = 0.4
submit_df = (df_app_chnnl['is_attributed'] * w_ac + df_app['is_attributed'] * w_a).reset_index()
#submit_df[['click_id', 'is_attributed']].to_csv('submean_app.zip', compression='gzip', index=False)
submit_df[['click_id', 'is_attributed']].to_csv('submean_app.csv', index=False)