# Validation of Pranav's LGB Model (as translated and revised by Andy)

# The original model is contained in:
#   https://www.kaggle.com/aharless/try-pranav-s-r-lgbm-in-python

# THE FOLLOWING NOTES REFER TO THAT KERNEL:
# Version 5 is a Python version of Pranav Pandya's R LightGBM:
...
# I added one mo level to freq. level.  (Tetyana Yatsenko)
# most_freq_hours_in_test_data    = [4, 5, 9, 10, 13, 14]
# middle1_freq_hours_in_test_data = [16, 17, 22] 
# least_freq_hours_in_test_data   = [6, 11, 15]

INCLUDE_LOCAL_VALIDATION_FOR_EARLY_STOPPING = False

MAX_ROUNDS = 1000
EARLY_STOP = 50
OPT_ROUNDS = 655

FULL_OUTFILE  = 'small_add_pranav_lgb_val_nostop.csv'
VALID_OUTFILE = 'small_add_pranav_lgb_val_withstop.csv'
...
train_df = pd.read_pickle('../input/training-and-validation-data-pickle/training.pkl.gz')[-100000000:]
...
if INCLUDE_LOCAL_VALIDATION_FOR_EARLY_STOPPING:
