# Using validation data from
#   https://www.kaggle.com/aharless/training-and-validation-data-pickle
# for Ravi Teja Gutta's LightGBM:
#   https://www.kaggle.com/rteja1113/lightgbm-with-count-features (v3)

# So far it seems to work:
#   validation = 0.9668  (see below)
#   LB score   = 0.9667  (see original)
...
print('load train...')
train_df = pd.read_pickle('../input/training-and-validation-data-pickle/training.pkl.gz')[:40000000]
print('load test...')
...
sub.to_csv('val_lgb_balanced99.csv',index=False)
print("done...")
print(sub.info())
