# THIS VERSION WRITES ALL ROWS OF TRAIN FILE BUT DROPS MOST COLUMNS
# DESCRIPTION BELOW IS FROM EARLIER FORK

# VERSION 2 PRESERVES ORIGINAL ORDER WITHIN CATEGORIES
...
print('\nLoading train again...')
df = pd.read_csv(path+"train.csv", dtype=dtypes, usecols=['ip','click_time'])
...
# Write to disk
print('\nWriting...')
df.to_pickle('narrow_train_with_time_deltas.pkl.gz')
print( 'Done')