...
for i in range(NRUNS):
    ...
    filename = '../input/new-preprocessed-train-subsamples-for-validation/train_sample' + str(i) + '.pkl.gz'
    ...
    emb_agg6 = Embedding(max_agg5, emb_n-10)(in_agg6) 
...
#    x = concatenate([embs, agg1_float, agg2_float, agg3_float, agg4_float, agg5_float, agg6_float])
...
#                          agg5_float, agg6_float], outputs=outp)
    ...
    time_deltas = pd.read_pickle('../input/training-and-validation-backward-time-deltas/validation_deltas.pkl.gz')
...
print("writing....")
sub.to_csv('gpu_val3.csv', index=False, float_format='%.9f')
print("Done")