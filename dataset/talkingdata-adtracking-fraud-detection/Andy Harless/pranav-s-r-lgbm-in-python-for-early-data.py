# For the early data that wouldn't fit in:
#   https://www.kaggle.com/aharless/try-pranav-s-r-lgbm-in-python
# Combine the results (with most weight on the other one)
...
FULL_OUTFILE = 'sub_lgbm_first_part_nocv.csv'
VALID_OUTFILE = 'sub_lgbm_first_part_withcv.csv'
...
train_df = pd.read_csv(path+"train.csv", nrows=84903891, dtype=dtypes, usecols=train_cols)
