...
train = pd.read_csv(path+'train.csv', skiprows=range(1,114903891), nrows=70000000, 
...
model = xgb.train(params, dtrain, 1000, watchlist, maximize=True, early_stopping_rounds=80, verbose_eval=10)
del dtrain
del dvalid
gc.collect()
