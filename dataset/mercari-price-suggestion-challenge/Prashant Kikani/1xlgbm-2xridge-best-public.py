...
def main():
    ...
    model = lgb.train(params, train_set=d_train, num_boost_round=9000, valid_sets=watchlist, \
    ...
    model = lgb.train(params2, train_set=d_train2, num_boost_round=4500, valid_sets=watchlist2, \
    ...
    preds = (predsR*0.2 + predsL*0.55 + predsR2*0.25)

    submission['price'] = np.expm1(preds)
    submission.to_csv("sub_2xridge_lgbm.csv", index=False)
