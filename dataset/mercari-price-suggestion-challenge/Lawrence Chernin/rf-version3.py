...
m1 = RandomForestRegressor(n_jobs=-1,min_samples_leaf=50,n_estimators=15)
m1.fit(x_train, y_train)
print(m1.score(x_train,y_train))

m2 = RandomForestRegressor(n_jobs=-1,min_samples_leaf=50,n_estimators=17)
m2.fit(x_train, y_train)
print(m2.score(x_train,y_train))

m3 = RandomForestRegressor(n_jobs=-1,min_samples_leaf=50,n_estimators=20)
