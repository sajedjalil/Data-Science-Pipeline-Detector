...
m1 = RandomForestRegressor(n_jobs=-1, n_estimators=100,  random_state=42, max_features=0.5, min_samples_leaf=3)
m1.fit(x_train, y_train)
print(m1.score(x_train,y_train))

m2 = RandomForestRegressor(n_jobs=-1, n_estimators=80,  random_state=22, max_features=0.5, min_samples_leaf=5)
m2.fit(x_train, y_train)
print(m2.score(x_train,y_train))

m3 = RandomForestRegressor(n_jobs=-1, n_estimators=90,  random_state=11, max_features=0.5, min_samples_leaf=4)
m3.fit(x_train, y_train)
print(m3.score(x_train,y_train))

preds = (m1.predict(df_test)+m2.predict(df_test)+m3.predict(df_test))/3.0
