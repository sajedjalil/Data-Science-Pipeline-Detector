...
def handle_missing_inplace(dataset):
    ...
    dataset['item_description'] =  dataset['item_description'] + ' ' +  dataset['name']
...
def main():
    ...
    model = Ridge(solver='sag', fit_intercept=True, random_state=123)
    model.fit(X, y)
    ...
    preds = (predsR*0.15 + predsL*0.3 + predsL2*0.3 + predsR2*0.25)
