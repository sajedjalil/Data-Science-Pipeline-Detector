...
def main():
    ...
    model = Ridge(alpha=.45, copy_X=True, fit_intercept=True, max_iter=100,
      normalize=False, random_state=1234, solver='auto', tol=0.01)
    model.fit(X, y)
    ...
    preds = predsR*0.3 + predsL*0.3 + predsL2*0.4
