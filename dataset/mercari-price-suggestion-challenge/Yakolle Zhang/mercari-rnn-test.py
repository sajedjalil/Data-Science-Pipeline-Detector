...
def get_nn_data(train_df, test_df, rnn_queue):
    ...
    max_len_dic = {'category_name_seq': 10, 'item_description_seq': 70, 'name_seq': 20}
...
def run_rnn(x, y, test_x, len_dic):
    ...
    def get_rnn_model():
        ...
        emb_desc_seq = Embedding(len_dic['item_description_seq'], 70)(desc_seq)
        emb_brand = Embedding(len_dic['brand_name_ind'], 10)(brand)
        emb_cat = Embedding(len_dic['category_name_ind'], 10)(cat)

        rnn_name_seq = GRU(8, activation='relu')(emb_name_seq)
        rnn_desc_seq = GRU(16, activation='relu')(emb_desc_seq)
