...
# %% [code]
BS=64
model_root = tf.keras.models.load_model('/kaggle/input/bengali-graphemes-resnet50-2/model_root_1.h5')
model_vowel = tf.keras.models.load_model('/kaggle/input/bengali-graphemes-resnet50-2/model_vowel_1.h5')
model_consonant = tf.keras.models.load_model('/kaggle/input/bengali-graphemes-resnet50-2/model_consonant_1.h5')
...
for i in range(4):
    ...
    print("[INFO] Now predicting probability on Test set from three saved models")
    graphemeProba = model_root.predict(test_set) 
    vowelProba = model_vowel.predict(test_set)
    consonantProba =  model_consonant.predict(test_set)
