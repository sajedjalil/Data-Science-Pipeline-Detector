...
Colors:
 - black = no data (whole row omitted, because zero sales)
...
Visualizing the history of a store, we can see:
 ...
 - Areas of neighbour products that go out of stock? (Black surrounded
   by blue/red).
 
 - Occassional missing days (horizontal black line).
...
The black pixels are 'omitted' training set rows. (In the test set area, last
