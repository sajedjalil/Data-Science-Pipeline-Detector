...
# [1] https://www.kaggle.com/christofhenkel/keras-baseline-lstm-attention-5-fold  (99% of it used)
# [2] https://www.kaggle.com/artgor/cnn-in-keras-on-folds (some ideas)
# [3] https://www.kaggle.com/ogrellier/user-level-lightgbm-lb-1-4480 (logger)
##
import numpy as np 
import pandas as pd 
import os
...
def run_model(X_train, X_test, y_train, embedding_matrix, word_index):
    ...
    for fold_, (trn_idx, val_idx) in enumerate(folds.split(X_train, y_train)):
        ...
        model.fit(X_train[trn_idx],
            ...
            epochs=NUM_EPOCHS,
            validation_data=(X_train[val_idx], y_train[val_idx]>0.5),
