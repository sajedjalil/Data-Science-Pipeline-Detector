...
def check_coverage(vocab, embeddings_index, col):
    ...
    coverage[0][col] = len(known_words)/len(vocab)
    coverage[1][col] = num_kw/(num_kw + num_uw)
...
oov = check_coverage(vocab, embeddings_index, 0)
...
vocab = build_vocab(train['comment_text'])
oov = check_coverage(vocab, embeddings_index, 1)
oov[:15] # Check 15 most common out of vocab words
...
# How much did our coverage improve?
vocab = build_vocab(train['comment_text'])
oov = check_coverage(vocab, embeddings_index, 2)
oov[:15] # Check 15 most common out of vocab words
