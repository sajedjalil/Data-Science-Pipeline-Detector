...
from keras.layers import Dense, Embedding, LSTM, GRU ,Input ,GlobalMaxPool1D, Dropout, Bidirectional
...
model.fit(x_train_pad,train_yy,batch_size=4096,epochs=5,validation_split=0.1,verbose=2)

prediction = model.predict(x_test_pad,verbose=2)
