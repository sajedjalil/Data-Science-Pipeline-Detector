...
print(ndcg_at_k([1,0,0],5, method=1))
print('--------')
print(ndcg_at_k([1,1,0,0,0],5, method=1))
print(ndcg_at_k([1,1,1,1,1],5, method=1))
print(ndcg_at_k([1,1,0,1,1],5, method=1))
print(ndcg_at_k([1,0,1],5, method=1))
print('--------')
