...
<meta charset="utf-8">
<style>canvas { display:block; width:860px; height:530px;}</style>
</head>
<body>
<canvas width="860" height="530"></canvas><br><small><a href="http://bl.ocks.org/mbostock/280d83080497c8c13152" target="_blank">Source</a></small>
<script>
