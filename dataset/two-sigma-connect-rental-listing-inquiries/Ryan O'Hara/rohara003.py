...
# Fit the model
model.fit(x_train.as_matrix(), dummy_y.as_matrix(), nb_epoch=64, batch_size=8, verbose=0)
# evaluate the model
#scores = model.evaluate(x_train.as_matrix(), dummy_y.as_matrix())
...
#labels2idx = {label: i for i, label in labels}
labels2idx
