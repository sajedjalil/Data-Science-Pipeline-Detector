...
train_df['room_sub'] = train_df['bedrooms'] - train_df['bathrooms']
test_df['room_sub'] = test_df['bedrooms'] - test_df['bathrooms']

# train_df['price_prm'] = float(train_df['price'])/float(train_df['room_sum'])
# test_df['price_prm'] = float(test_df['price'])/float(test_df['room_sum'])
...
# count for "street address"
train_df["num_address"] = train_df["street_address"].apply(len)
test_df["num_address"] = test_df["street_address"].apply(len)
...
"num_photos", "room_sum","room_sub", "num_address","num_features", "num_description_words", "created",
"created_year", "created_month", "created_day", "created_hour","created_min","created_sec",
"created_weekday","created_quarter","created_week","x2","y2","x3","y3","dist_to_center"]

# features_to_use=["bathrooms", "bedrooms", "latitude", "longitude", "price",
# "num_photos", "room_sum","room_sub","price_prm", "num_address","num_features", "num_description_words",
# "created_year", "created_month", "created_day", "created_hour","created_min","created_sec",
# "created_quarter","created_week","dist_to_center"]
