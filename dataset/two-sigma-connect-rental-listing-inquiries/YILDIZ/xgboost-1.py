...
train_df.ix[train_df["bathrooms"] > 5, "bathrooms"] = 5
train_df.ix[train_df["bedrooms"] > 5, "bedrooms"] = 5
ulimit = np.percentile(train_df.price.values, 99)
train_df.ix[train_df["price"]>ulimit, "price"] = ulimit
...
outliers = train_df[(train_df["latitude"] < min_lat) | (train_df["latitude"] > max_lat) | 
                    (train_df["longitude"] < min_long) | (train_df["longitude"] > max_long) ]
...
out_df.to_csv("xgboost_1.csv", index=False)