...
# Generate a dictionary of the time limits so it doesn't have to be recalculated each loop
...
x_cuts = 30 # number of cuts along x 
y_cuts = 15 # number of cuts along y
