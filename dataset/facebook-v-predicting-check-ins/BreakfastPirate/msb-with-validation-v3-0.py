...
def run_solution():
    ...
    total = 0
    grid_size_x = 275 #500
    grid_size_y = 750 #1000
    grid_size_x2 = 100
    grid_size_y2 = 200
    # Maximum T = 786239. Take -10% of it
    split_t = math.floor((1.0 - 0.1) * 786239)
    out_of_business_time = 0.06
    split_test_out_of_business = math.floor((1.0 - 0.1 - out_of_business_time) * 786239)
    ...
    while 1:
        ...
        # grid[((ix2+10000), (iy2+10000))][place_id] += 1 * log_month
        ...
        if time1 < split_t:
            ...
            # grid_valid[((ix2+10000), (iy2+10000))][place_id] += 1 * (log_month)
            train_samples += 1
