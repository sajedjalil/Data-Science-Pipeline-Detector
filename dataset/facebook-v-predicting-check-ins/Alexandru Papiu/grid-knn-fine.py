...
def prepare_data(df, n_cell_x, n_cell_y):
    ...
    df['hour'] = (d_times.hour + d_times.minute/60) * fw[2] #I change it here to make it more fine grained.
    df['weekday'] = (d_times.weekday + d_times.hour/24) * fw[3]
    #df['day'] = (d_times.dayofyear  + d_times.hour/24)* fw[4]
    df['month'] = d_times.month * fw[4]
    df['year'] = (d_times.year - 2013 + d_times.month/12) * fw[5]
