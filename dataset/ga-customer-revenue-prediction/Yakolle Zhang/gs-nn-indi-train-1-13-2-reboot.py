...
need_accelerator = 1 == indi_type_id and seg_func.__name__ == plseu.__name__

lr_patience = 10 if not need_accelerator else 15
stop_patience = 15 if not need_accelerator else 25
epochs = 100
batch_size = 1024
...
def learn(data):
    ...
    for i in range(c, repeat_times):
        ...
        for tind, vind in fold_inds:
            ...
            accelerator = CVAccelerator(monitor='val_loss', tol=min_delta, regret_rate=0.1, cooldown=2, verbose=1)
