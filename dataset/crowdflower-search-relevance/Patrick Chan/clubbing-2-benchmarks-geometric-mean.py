...
if __name__ == '__main__':
    ...
    #svm_model = SVC(C=10.)
    svm_model = SVC(C=10.0, kernel='rbf', degree=3, gamma=0.0, coef0=0.0, shrinking=True, probability=False, tol=0.0001, cache_size=200, class_weight=None, verbose=False, max_iter=-1, random_state=None)
    ...
    clf = Pipeline([('v',TfidfVectorizer(min_df=4, max_df=500, max_features=None, strip_accents='unicode', analyzer='word', token_pattern=r'\w{1,}', ngram_range=(1, 3), use_idf=True, smooth_idf=True, sublinear_tf=True, stop_words = 'english')), 
    ...
    submission.to_csv("drpatensemble_svc_different_preproc1.csv", index=False)
