"""
	...
	__description__: Normalized Kaggle Distance for visualization, topic modeling and semantic 
					 ...
					 which in turn is based on Kolmogorov Coappmplexity.
...
if __name__ == "__main__":
	...
	film_studios = ["Ferrari","Porsche","Fox","Mclaren","Lamborghini","Fiat"]
	html5 = multiple_choice(d,"Which car manufactured produces red cars?","Red",film_studios)
	html6 = multiple_choice(d,"Which car manufacted produces the panda?","Panda",film_studios)
	"""
    cars_manufactured = ["Ferrari","Porsche","Mclaren","Lamborghini","Fiat"]
	html5 = multiple_choice(d,"Which car manufactured produces red cars?","Red",cars_manufactured)
	html6 = multiple_choice(d,"Which car manufacted produces the panda?","Panda",cars_manufactured)
    """
