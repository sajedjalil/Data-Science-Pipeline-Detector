...
clf = ensemble.RandomForestRegressor(random_state=123, verbose=3, criterion="mse", n_jobs=4)
params = dict(n_estimators=[100, 500, 1000], 
    max_depth=[6, 10, None], 
    min_samples_leaf=[5, 10, 50],
    max_features=[2, 5, 10, 20, 40])
rf_gs = grid_search.GridSearchCV(clf, params, cv=5, 
