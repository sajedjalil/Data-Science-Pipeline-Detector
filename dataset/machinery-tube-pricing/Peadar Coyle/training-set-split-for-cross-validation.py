...
def boosted_learning(labels, train, test):
    label_log=np.log1p(labels)
    clf=ExtraTreesRegressor(n_estimators=1000, min_samples_split=1, max_depth=15, max_feature=30)
    model=clf.fit(train, label_log)
...
if __name__ == '__main__':
    ...
    #datapath='./pickledata/xgb_benchmark.dat'
    # train, test, idx, labels=load_data(datapath)
    ...
    if test_run:
        ...
        for run in range(1, 11):
            ...
            tr_preds = boosted_learning(tr_train_y, tr_train, tr_test)
