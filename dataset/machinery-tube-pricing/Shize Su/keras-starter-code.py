...
model.fit(train, label_log, batch_size=32, nb_epoch=30, verbose=2, validation_split=0.30)

# train model on full data, test on 15% hold out data
#model.fit(train, label_log, batch_size=32, nb_epoch=30, verbose=2, validation_split=0.01)
