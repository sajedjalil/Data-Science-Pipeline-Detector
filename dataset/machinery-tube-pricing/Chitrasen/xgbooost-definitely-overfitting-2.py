...
train['volume'] = (np.square(train.diameter+train.wall) - np.square(train.diameter))* train.length
test['volume'] = (np.square(test.diameter+train.wall) - np.square(test.diameter))* test.length
