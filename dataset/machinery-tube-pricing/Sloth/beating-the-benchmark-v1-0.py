...
rf = ensemble.RandomForestRegressor(n_estimators=1000, n_jobs=-1)

# tune parameters
#parameters = {'n_estimators':(1000, 2000)}
#clf = grid_search.GridSearchCV(gbm, parameters, verbose=1)

clf = rf

# cross validation
print("k-Fold RMSLE:")
cv_rmsle = cross_validation.cross_val_score(clf, train, label_log, scoring='mean_squared_error', n_jobs=-1, cv=5)
print(cv_rmsle)
