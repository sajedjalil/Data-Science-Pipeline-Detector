...
def get_hashes(arr):
    ...
    if 1:
        ...
        sub.append((2, ncodpers))
        sub.append((3, ind_empleado,ind_actividad_cliente,ind_nuevo,canal_entrada))
        sub.append((4, pais_residencia, sexo, renta1, age, segmento))
        sub.append((5, pais_residencia, sexo, antiguedad, segmento, ind_empleado))
    else:
        # Random set
