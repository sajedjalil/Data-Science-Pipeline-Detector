...
hashes_indexes = random.sample(list(all), 3)
...
def get_hashes(arr):
   ...
   # if 1:
        # Fixed set
    sub.append((1, renta1,  pais_residencia, sexo, age, ind_nuevo, segmento, ind_empleado, ind_actividad_cliente, indresi))
    sub.append((2,renta1,  pais_residencia, sexo, age,  ind_nuevo, ind_actividad_cliente, canal_entrada,ind_empleado))
    #sub.append((2,renta1,  pais_residencia, sexo, age, segmento, nomprov, ncodpers, antiguedad, ind_nuevo, ind_actividad_cliente, canal_entrada, ind_nuevo,canal_entrada ,ind_empleado))
