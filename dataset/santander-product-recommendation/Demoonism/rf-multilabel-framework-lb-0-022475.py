...
if __name__ == "__main__":
	...
	print("Running Model..")
	model1 = ensemble.RandomForestClassifier(n_estimators=70, max_depth=10, min_samples_leaf=10, n_jobs=4, random_state=2016)
	model1.fit(train_X, train_y)

	del train_X, train_y
	print("Predicting..")
	preds = np.array(model1.predict_proba(test_X))[:,:,1].T
	...
	out_df.to_csv('ensemble_base.csv', index=False)