...
if __name__ == "__main__":
	...
	train_size = 13647309
	nrows = 1360000 # change this value to read more rows from train
	...
	print("Running Model..")
	model = ensemble.RandomForestClassifier(n_estimators=20, max_depth=20, min_samples_leaf=15, n_jobs=4, random_state=2016)
