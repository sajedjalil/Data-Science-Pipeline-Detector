...
if __name__ == '__main__':
    ...
    alldays = [maxactivdate - datetime.timedelta(days=x) 
    for x in range(0, (maxactivdate - minactivdate).days+1)]  
    ...
    allCompaniesAndDays = allCompaniesAndDays.groupby('group_1').apply(interpolateFun1)
